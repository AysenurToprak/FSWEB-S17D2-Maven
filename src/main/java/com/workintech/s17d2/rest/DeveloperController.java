...
public class DeveloperController {
    ...
    public void init() {
        ...
        this.developers.put(1,new SeniorDeveloper(1,"aysenur",1000d));
    ...
    public DeveloperResponse save(@RequestBody Developer developer) {
        ...
        return  new DeveloperResponse(createdDeveloper,HttpStatus.CREATED.value(),"Created işlemi başarılı");
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id) {
        ...
        if (foundDeveloper == null){
            return new DeveloperResponse(null,HttpStatus.NOT_FOUND.value(), "id ile searchte bulunamadı");

        }
        return new DeveloperResponse(foundDeveloper,HttpStatus.OK.value(), "id ile bulundu");
    }
    @PutMapping("/{id}")
